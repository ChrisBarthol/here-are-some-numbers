...
/***/ function(module, exports) {
	...
	var _user$project$Main$Model = F3(
		function (a, b, c) {
			return {dieFace: a, content: b, maxNum: c};
		});
	var _user$project$Main$init = {
		ctor: '_Tuple2',
		_0: A3(_user$project$Main$Model, 1, 'Choose a Max', 10),
		_1: _elm_lang$core$Platform_Cmd$none
	};
	var _user$project$Main$Max = function (a) {
		...
		function (msg, model) {
			...
			switch (_p0.ctor) {
				...
				case 'NewFace':
					return {
						ctor: '_Tuple2',
						_0: A3(_user$project$Main$Model, _p0._0, 'Choose a Max', model.maxNum),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				default:
					return {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Get New Number')
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$placeholder('Max Number'),
									_elm_lang$html$Html_Events$onInput(_user$project$Main$Max)
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
